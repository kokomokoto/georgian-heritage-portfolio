...
def save_projects(projects):
    """Persist projects to the database."""
    print(f"save_projects: {len(projects)} projects")
    try:
        ...
        for project_data in projects:
            ...
            fields = {
                ...
                'model_urls': json.dumps(project_data.get('model_urls', [])),
            ...
            if existing_project:
                ...
                db.session.add(Project(id=project_id, **fields))
...
def delete_project(project_id):
    # Remove project folder and update database
